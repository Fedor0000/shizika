...
$dr$ - расстояние, на которое отодвинулся $q'$ при перемещении $dS$. Работа поля: $dA=\overrightarrow{F}_\text{кул.}d\overrightarrow{S}$, $\overrightarrow{e}_{\text{r}}\cdot d\overrightarrow{S}=dR$.
...
2) Работа по замкнутой траектории равна нулю (A=0), так как при возвращении в ту же точку потенциальная энергия тоже возвращается, и в итоге убыли нет. $A=\oint_{L}\overrightarrow{F}_\text{кул.}d\overrightarrow{L}=\boxed{\oint_{L}\overrightarrow{E}q'd\overrightarrow{L}=0}$ - теорема о циркуляции. `Циркуляция вектора напряженности` вдоль замкнутой траектории L равна 0.
...
![кирпипич](картинки/кирпипич.png)
